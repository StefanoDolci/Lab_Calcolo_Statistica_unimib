...
# ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----
# ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----
#Example of plotting multiple histogram syntax
...
# ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----
# ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----
#Example of plotting errorbar plot

x_coord1 = np.linspace(0,0.5,1000)
y_coord1 = model(x_coord1,m.values[''])

x_coord2 = np.linspace(0,0.5,1000)
y_coord2 = model_decell(x_coord2,m2.values[''],m2.values[''])

plt.plot(x_coord1, y_coord1, label='', linewidth=2, color='blue')
plt.plot(x_coord2,y_coord2,label='',linewidth=2,color='red')
plt.errorbar(redshift, dist, yerr=dist_err, fmt='.', label='',color="grey")
plt.xlabel('x')
plt.ylabel('y')
plt.legend()
plt.grid(True)
